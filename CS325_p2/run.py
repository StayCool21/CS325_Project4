...
import os
from module_1.mod1_funct1 import get_url_from_file, get_raw_from_file, ensure_cbsnews_domain, test_urls
...
def main():
    ...
    # returns a list of failed URLs (if any)
    failed_urls = test_urls(urls)
